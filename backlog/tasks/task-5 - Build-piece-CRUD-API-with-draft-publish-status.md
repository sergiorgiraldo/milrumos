...
- [ ] #2 Section content is stored and retrieved as raw markdown text
- [ ] #3 Every save call inserts a new row in piece_versions with a full markdown snapshot and incremented version_number
- [ ] #4 Author can update any field of their own piece
- [ ] #5 Author can delete their own piece (cascades to sections, versions, and lineage rows)
- [ ] #6 Author can toggle status between draft and published
- [ ] #7 Other authenticated users cannot mutate a piece they do not own (returns 403)
- [ ] #8 Unit tests cover create, update, delete, publish, versioned-save, and permission-denial cases
<!-- AC:END -->
